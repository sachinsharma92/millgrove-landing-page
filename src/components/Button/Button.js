...
const Button = ({leftIcon,rightIcon,text,customStyles,type,isRounded}) => {
  ...
  return (
    <button className={`${getClassname(type)} ${styles.btn} ${isRounded && styles.rounded}`} style={customStyles && {...customStyles}}>
